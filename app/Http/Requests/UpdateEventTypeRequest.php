    ...
    public function rules(): array
    {
        ...
        return [
            'system_event_title' => [
                ...
                'string',
                'max:255',
                Rule::unique('event_types', 'system_event_title')->ignore($eventTypeId)
            ],
            'priority' => ['sometimes', 'required', Rule::enum(Priority::class)],
            'title_display_translation' => ['sometimes', 'required', 'array'],
            'title_display_translation.en' => ['required_with:title_display_translation', 'string', 'max:255'],
            'title_display_translation.es' => ['required_with:title_display_translation', 'string', 'max:255'],
            'title_display_translation.ru' => ['required_with:title_display_translation', 'string', 'max:255'],
            ...
            'notification_mode' => ['sometimes', 'required', Rule::enum(NotificationMode::class)],
