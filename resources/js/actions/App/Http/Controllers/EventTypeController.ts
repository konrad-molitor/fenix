...
* @route '/api/event-types/{eventType}'
*/
const update3e206cce5dbe8986698e8d526e57e368 = (args: { eventType: number | { id: number } } | [eventType: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: update3e206cce5dbe8986698e8d526e57e368.url(args, options),
    method: 'put',
})

update3e206cce5dbe8986698e8d526e57e368.definition = {
    methods: ["put"],
    url: '/api/event-types/{eventType}',
...
* @route '/api/event-types/{eventType}'
*/
update3e206cce5dbe8986698e8d526e57e368.url = (args: { eventType: number | { id: number } } | [eventType: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { eventType: args }
    }
    ...
    return update3e206cce5dbe8986698e8d526e57e368.definition.url
            .replace('{eventType}', parsedArgs.eventType.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @route '/api/event-types/{eventType}'
*/
update3e206cce5dbe8986698e8d526e57e368.put = (args: { eventType: number | { id: number } } | [eventType: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: update3e206cce5dbe8986698e8d526e57e368.url(args, options),
    method: 'put',
})
...
* @route '/api/event-types/{eventType}'
*/
update3e206cce5dbe8986698e8d526e57e368.patch = (args: { eventType: number | { id: number } } | [eventType: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: update3e206cce5dbe8986698e8d526e57e368.url(args, options),
    method: 'patch',
})
